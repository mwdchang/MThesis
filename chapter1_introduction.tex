...
concrete attributes. Consider the popular technique of word cloud (\ie, 
\cite{VIE2009a}): the size of tags is linked to the word frequency, but the
rendering of the cloud is out of context with respect to the physical meaning of these words.
...
mapping function that takes the entity relations as parameters and outputs a
stylized graphical effect which is applied to the geometric components, this is used to 
denote the level or severity of the semantic relations. The subject matter can 
...
Chapter 2 provides a literature review that discusses related works and
researches that served as our inspirations. Chapter 3 discusses the problem and
