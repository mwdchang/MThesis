...
measures, the structures of the documents and word semantics. The field of
...
techniques for text documents, there are few visualizations that leverages
real-world dimensions that may exist in text documents, in the sense that these
are presented in an abstract manner, rather than in-line with real-world
expectations. 

Consider a review article of a bicycle, it contains words
referring to bicycle parts that have real-world manifestations, there are also
inherent spatial relation among different bicycle parts. Now, consider the
