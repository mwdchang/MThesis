...
diaries, blogs and incident reports. These documents contain a wealth of
information that can be extracted and analyzed such as various statistical
measures, grammatical structures and lexical semantics. The field
of Information Visualization (InfoVis) deals  with the visual representation of
...
to physical subjects or inherent spatial structures. Rather then showing these
dimensions in a recognizable form, these applications present abstract renderings that are out of context.
