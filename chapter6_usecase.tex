...
type of experience with touch interfaces such as tablets and smart phones. 6
...
some way. 
	...
	\begin{figure}
	 \centering  
	 \includegraphics[width=\columnwidth]{gesture2_2.png}  
	 \caption{Study setup.}
	 \label{figure:study}
	\end{figure}
	% ==============
...
collected during the sessions. We use the video recordings to review 
...
For the system logs, we track user input events that impact system states such
as changes selections and data filters. We also track widget usages, when they were used and
