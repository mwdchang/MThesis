...
to represent the virtual model, a double encoding of these variables is likely 
going to lead to confusion, either compromise the reliability of the visualization, 
or destroy any resemblance of the virtual model to its real world counterpart. 
Size is an interesting one, in theory size can support most of the characteristics. 
However it is implied that all the objects of the same value have the equal size, 
...
textures to simulate certain effects, for example a rusty surface. We leave this 
