...
its real world counterpart. Thus were rejected as ways to encode the score. 
Size is an interesting one, in theory size can support most of the
...
while they do not provide a sense of quantitative measure, the capability to see ordering, 
...
%can be seen in Figure \ref{figure:visualEncoding}.
	...
	\begin{figure}
	   ...
	   was selected a the final design; parts are not distinguishable in the top row, while the 
	   bottom left did not have a strong pop-out effect.}
...
filters.
	...
	\begin{figure}
	 ...
	 \caption[Interactive Filters]{Time widget and hierarchy widget in
	 interactive mode}
	...
	\begin{figure}
	 ...
	 \caption[Compact Filters]{Time widget and hierarchy widget in compact mode}
...
Each level of the hierarchy is shown in individual widget. We position the
...
\begin{itemize} [noitemsep]
  \item Perspective Manipulation: Perspective manipulation consists of rotation
