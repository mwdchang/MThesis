...
objects [Viola2004]. In this paper the authors assign scores to volumetric 
...
divided into focus, near-focus and context components [Tietjen2005]. In this scheme, 
different rendering styles are used for focus, near-focus and context objects to 
...
Summary: We take an approach similar to CarComVis [Seldmair2009], we generated a
virtual vehicle based on the components mentioned in our dataset. However, rather 
