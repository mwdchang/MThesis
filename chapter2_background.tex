...
\cite{WAR2004b}, humans can see and complete entire shapes with just a few
...
Scientific Visualization community, they deal with visibility issues to
...
they described a segmentation scheme that partitions different volumes into
...
Traditionally Information Visualization deals with abstract data,
Scientific Visualization, on the other hand, deals with visualization of
...
visualization from Doleisch \etal, which uses multiple coordinated views, and
linking and brushing techniques are used to further help the exploration
...
Hauser~\cite{Hauser2006} reviewed the general approaches and demonstrated
the usage of colour, spatial-location, opacity and other resource. One
interesting use of the focus+context technique is the idea of using lenses, the
...
where the data graphics under the lens undergoes a graphical transformation in
...
lenses that undergoes geometric distortion: distorted graphics are more
