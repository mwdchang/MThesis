...
select the appropriate visual representation, termed visual variables
\cite{BER1983a}. Visual variables dictates how a graphical mark is drawn and includes the mark’s 
...
allow rich and meaningful exploration of data. Shneiderman’s
information seeking mantra set the standard for exploratory graphical user interface \cite{Shneiderman1996} . They
are, in order:
