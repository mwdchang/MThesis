...
against every pixel in the image. Any pixels that fall below a specified
threshold are discarded, the remaining pixels are collected and aggregated
...
In the InfoVis space, research by Sedlmair \etal~looked at enriching
...
taken into three dimensional space, unlike the previously mentioned works,
