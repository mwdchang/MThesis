...
A pure abstract visualization may not have the best data representation, when 
the data itself has inherently physical/spatial dimensions. In this chapter, we discuss why
...
%In order to derive concrete requirements for our use case, 
%we needed to determine the considerations which are most important 
%to a consumer, whether for purchasing or for defect investigation.

%In order to have develop real insights about the data, our design for this
%scenario needs to have requirements that that takes into consideration how 
%the data can be used for a consumer or analyst. That is, we need our design 
%to facilitate people making decisions in purchasing a vehicle or for 
