...
I would also like to thank my friends in the vialab (Rafael, Brittany, Erik,
Zack and Tanvir), who gave me valuable ideas about my thesis and being there for me
when I needed a break from work. 
\end{acknowledgements}

\begin{listofpublications}
%\textbf{List of publications resulting directly from this thesis}
The following publication resulted from the research presented in this thesis:
\\
\\
Meng-Wei Chang, Christopher Collins. Exploring Entities in Text with Descriptive
Non-photorealistic Rendering. (To Appear) In \textsl{Proc. of the 2013 IEEE
Pacific Visualization Symposium (PACIFICVIS '13). 2013.} 

%Meng-Wei Chang, Christopher Collins. Exploring Entities in Text with
% Descriptive Non-photorealistic Rendering. \textsl{PacificVis'10: IEEE Pacific Visualization
%Symposium, Mar 2013}
...
\include{chapter3_problem}
\include{chapter4_data_processing}
\include{chapter4_design} 
\include{chapter4_analysis}
\include{chapter5_implementation} 
\include{chapter6_usecase}
