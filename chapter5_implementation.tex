...
Na\"\i vely we can use either sort the geometries or use space partitions to force
...
\begin{itemize} [noitemsep]
  ...
  \item \textbf{Movement Buffer:} When a gesture is in transition (moving), there are
  ...
  least P pixels distance in magnitude. This heuristic is not applicable to
